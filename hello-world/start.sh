...
docker -H $DOCKER_ADDRESS run -rm --name hello-world-demo --hostname hello-world-demo -p 18080:8080 -v `pwd`/conf/image/:hello-world/conf $REGISTRY_ADDRESS/$IMAGE_NAME